...
import { useApplicationList } from "~/composables/applications/useApplicationList.ts";
...
<template>
  ...
  >
    <template #button>
      ...
      <template v-else-if="!applications || applications.length === 0" />
      <template v-else>
    ...
    <template v-if="!loading && (!applications || applications.length === 0)">
